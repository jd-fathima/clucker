...
class User(AbstractUser):
    ...
    )#many to many relationship from self to self, not symmetrical as i follow a person the person dont follow me
    #relationship name is for the reverse relationship
