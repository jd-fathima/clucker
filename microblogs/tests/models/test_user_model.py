...
class UserModelTestCase(TestCase):
    ...
    def test_username_can_be_30_charac_long(self):
        self.user.username = '@' + 'x' * 29
        self._assert_user_is_valid()

    def test_username_can_be_over_30_charac_long(self):
    ...
    def test_username_must_contain_alphanumerical_after_at(self):
        self.user.username = '@john!doe'
        self._assert_user_is_invalid()

    def test_username_must_contain_atleast_3alphanumericals_after_at(self):
    ...
    def test_email_must_contain_contain_at_symbol(self):
    ...
    def test_bio_must_not_be_blank(self):
        self.user.bio = ''
        self._assert_user_is_valid()
